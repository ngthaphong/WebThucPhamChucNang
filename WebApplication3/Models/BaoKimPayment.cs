...
class BaoKimPayment
{
    ...
    //Mã merchant site
    private string merchant_id = "33454";	//Thay bằng mã merchant site bạn đã đăng ký trên BaoKim.vn

    //Mật khẩu bảo mật
    private string secure_pass = "a6c332b1e4a86279";	//Thay bằng mật khẩu giao tiếp giữa website của bạn với BaoKim.vn
