...
namespace WebApplication3.Controllers
{
    public class PaypalController : Controller
    {
        ...
        private double? DoiDonVi(double? vnd)
        {
        ...
        {
            return TempData["Tongtien"] as double?;
        }

        private int? TongSoLuong()
        {
            return TempData["Tongsoluong"] as int?;
        }

        private Payment CreatePayment(APIContext apiContext, string redirectUrl)
        {
            double? tien = DoiDonVi(TongTien());
            double? thue = tien * 0.1;
            double? ship = (double?)1 * TongSoLuong();
            /*
            ...
            */
            ...
            {
                currency = "USD",
                total = (thue+ship+tien).ToString(), // Total must be equal to sum of shipping, tax and subtotal.
                details = details
            };
